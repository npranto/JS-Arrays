...
var arr = [40,50,60];
//Create a function named 'last' that is given 'arr' as the argument and returns the 
//last item in the given array.
...
//and loops through the given array backwards alerting every item in the array starting
//at the end.
...
//(all the odd values from nums).
  ...
  function divider(numbersArray) {
    ...
    var evenValues = [];
    var oddValues = [];
    dividerArray.push(evenValues, oddValues);
...
//There is also a commented out array full of numbers to help you visualize what your 
//function will be receiving.

// Your job is to write a function named finder that will get a random number (by 
// invoking getRandomArbitrary), then loop through the array (that will be passed in 
// as a parameter) to see if that random number is in the array. If it is, return true,
...
/*
  ...
  off of our grocery list, and adding new items to our list.

  Write a function called removeItem that is given two arguments, the first is 
  myGroceryList, and the second is an item to remove from myGroceryList. If the second 
  argument (or the item to add or remove) matches an item in myGroceryList, remove that 
  ...
  In addItem add the item you passed in to myGroceryList then return the new, updated 
  grocery list.

  In both the removeItem function and the addItem function, you will also need to check 
  for valid aurguments. Specrunner will try to call your functions without passing in 
  valid aurguments. When this happens, you will need to respond by returning an empty 
  array.
*/
...
//Write a function called addTen that is given 'numbers' as it's only argument and 
//returns a new array after adding ten to each item in numbers. *Verify your answer 
//is correct. --> [15, 19, 26, 29, 35, 44, 58]
...
/*As a continuation of the previous problem, write another function called 'both'.
  Your 'both' function will be given two arguments, arr1 and arr2 (from the previous 
  example).
